...
func (c *mutatingWebhookConfigurationsClusterClient) Cluster(cluster logicalcluster.Path) admissionregistrationv1beta1client.MutatingWebhookConfigurationInterface {
