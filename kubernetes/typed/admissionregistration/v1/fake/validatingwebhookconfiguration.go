...
func (c *validatingWebhookConfigurationsClusterClient) Cluster(cluster logicalcluster.Path) admissionregistrationv1client.ValidatingWebhookConfigurationInterface {
